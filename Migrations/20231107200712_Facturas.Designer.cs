...
namespace WebAPIAutores.Migrations
{
    ...
    [Migration("20231107200712_Facturas")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPIAutores.Entities.Factura", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAPIAutores.Entities.FacturaEmitida", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAPIAutores.Entities.LlaveAPI", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAPIAutores.Entities.Peticion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAPIAutores.Entities.RestriccionDominio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAPIAutores.Entities.RestriccionIP", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RestricionesIP");
                });

            modelBuilder.Entity("WebAPIAutores.Entities.Usuario", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebAPIAutores.Entities.Usuario", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebAPIAutores.Entities.Comentario", b =>
                {
                    ...
                    b.HasOne("WebAPIAutores.Entities.Usuario", "Usuario")
                        .WithMany()
            ...
            modelBuilder.Entity("WebAPIAutores.Entities.Peticion", b =>
                {
                    b.HasOne("WebAPIAutores.Entities.LlaveAPI", "Llave")
                        .WithMany()
